...
let
  ...
  mkNetwork = meta: let
    ...
    dnsConfig = { domain = net.dns_domain; servers = net.dns_servers; };
  ...
  in
    if mode == "single-internal" then {
      ...
      initialization = {
        ...
        dns = dnsConfig;
        ip_config = [{
          ipv4 = { address = "${meta.internal_ip}/24"; gateway = net.gateway; };
        }];
      };
    }
    ...
    # `meta.ip`.
      ...
      initialization = {
        ...
        dns = dnsConfig;
        ip_config = [{
          ipv4 = { address = "${meta.ip}/24"; gateway = net.lan_gateway; };
        }];
      };
    }
  ...
  mkVm = name: meta:
    ...
    in {
      ...
      initialization = {
        ...
        type = "nocloud";
        dns = { domain = net.dns_domain; servers = net.dns_servers; };
      } // (
