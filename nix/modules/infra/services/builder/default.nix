...
let
  ...
  cfg = config.infra.builder;
  sopsLib = import ../../../../lib/sops.nix { inherit lib; };
in
{
  imports = [ ./registry-proxy.nix ./hydra.nix ./attic.nix ./lxc-template-factory.nix ./wiki-publisher.nix ];
  options.infra.builder = {
